...
router.get('/voucher/:code', authenticate, (req, res, next) =>
  orderController.getVoucherByCode(req, res, next)
);

// Redeem a voucher
router.put('/voucher/:code/redeem', authenticate, (req, res, next) =>
